...
const stackIcons = [
    ...
    { name: 'Typescript', src: '/stack/Typescript.webp' },
    { name: 'JavaScript', src: '/stack/javascript.webp' },
    { name: 'React', src: '/stack/react.webp' },
    { name: 'Next.js', src: '/stack/nextjs.webp' },
    { name: 'Node.js', src: '/stack/nodejs.svg' },
    { name: 'Express', src: '/stack/express.webp' },
    { name: 'Tailwind CSS', src: '/stack/tailwind.webp' },
    { name: 'MySQL', src: '/stack/mysql.webp' },
    { name: 'PostgreSQL', src: '/stack/psql.webp' },
    { name: 'Solidity', src: '/stack/solidity.webp' },
    { name: 'Hardhat', src: '/stack/hardhat.webp' },
    { name: 'Fedora', src: '/stack/fedora.webp' },
];
