                            ...
                            <div key={exp.id} className="flex flex-col">
                                ...
                                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-2 lg:gap-8">
                                    <div className="flex-1">
                                        <h3 className="text-xl lg:text-2xl font-bold text-brand-navy">
                                            {exp.role}
                                        </h3>
                                        <p className="text-lg text-brand-navy/70 mt-1 font-medium">
                                            {exp.company}
                                        </p>
                                    </div>
                                    <div className="lg:text-right mt-1 lg:mt-0 shrink-0">
                                        <span className="text-brand-navy/60 font-medium">
                                            {exp.date}
                                        </span>
                                    </div>
                                </div>
                                ...
                                {/* Description */}
                                {exp.description && (
                                    <p className="mt-4 text-brand-navy/80 leading-relaxed text-justify">
                                        {exp.description}
                                    </p>
                                )}
